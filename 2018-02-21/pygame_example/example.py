...
# this example game draws 3 concentric circles on top of a single
# color background the circles move down every time frame
...
class Example:
    ...
    # move the circles to the left side of the window every time
    ...
    def draw( self, surface ):
        ...
        pygame.draw.rect( surface, self.mDSUBlack, rect, 20 )
